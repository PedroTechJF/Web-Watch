...
SITES_PROIBIDOS = ["OpenAI", "Meta AI", "artificial", "inteligência artificial", "Gemini", "Chat", "GPT", "ChatGPT", "Bard", "Claude", "Ernie Bot", "LLaMA", "Mistral", "Manus", "NotebookLM", "Copa", "Cup", "Caze", "Cazé", "TV", "CazéTV", "cazetv"]
